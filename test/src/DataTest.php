...
EOT;
    ...
    public function testCanCreateLibraryWithObjectstorageDriver(): void
    {
        $config = [
            'name' => 'Customized Library',
            Library::CONFIG_LIBRARYSTORAGE => [
    ...
    public function testCanCreateLibraryWithObjectstorageDriverAndAddContent(): void
    {
        $config = [
            'name' => 'Customized Library',
            Library::CONFIG_LIBRARYSTORAGE => [
...
EOT;
    ...
    public function testCanCreateLibraryWithObjectstorageDriverAndAddContentFromTemplate(): void
    {
        $config = [
            'name' => 'Customized Library',
            Library::CONFIG_LIBRARYSTORAGE => [
